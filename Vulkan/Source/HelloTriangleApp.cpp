...
void HelloTriangleApp::CreateRenderPass()
{
	...
	// https://docs.vulkan.org/tutorial/latest/07_Depth_buffering.html#_render_pass
...
void HelloTriangleApp::CreateGraphicsPipeline()
{
	...
	// https://docs.vulkan.org/tutorial/latest/07_Depth_buffering.html#_depth_and_stencil_state
...
void HelloTriangleApp::RecordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
	...
	// https://docs.vulkan.org/tutorial/latest/07_Depth_buffering.html#_clear_values
...
void HelloTriangleApp::CreateDescriptorSetLayout()
{
	...
	// https://docs.vulkan.org/tutorial/latest/06_Texture_mapping/02_Combined_image_sampler.html#_updating_the_descriptors
...
void HelloTriangleApp::UpdateUniformBuffer()
{
	...
	float speed = m_Rotate ? 0.2f : 0.0F;
...
void HelloTriangleApp::CreateTextureImage()
{
	...
	CreateImage(textureWidth, textureHeight, m_MipLevels, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, m_TextureImage, m_TextureImageMemory);
...
void HelloTriangleApp::CreateImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
void HelloTriangleApp::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels)
{
	...
	// https://docs.vulkan.org/tutorial/latest/07_Depth_buffering.html#_explicitly_transitioning_the_depth_image
...
void HelloTriangleApp::GenerateMipmaps(VkImage image, VkFormat imageFormat, int32_t textureWidth, int32_t textureHeight, uint32_t mipLevels)
{
	// https://docs.vulkan.org/tutorial/latest/09_Generating_Mipmaps.html#_linear_filtering_support
